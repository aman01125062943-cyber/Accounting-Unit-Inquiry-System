...
### Session 2026-04-14 (Salary Alignment)

- Q: هل يتم مطابقة أعمدة المرتبات مع الحوافز (17 عمود) أم الحفاظ على الرقم القومي؟ → A: يتم اعتماد قائمة الـ 17 عمود الخاصة بالحوافز مع إضافة "الرقم القومي" كعمود أساسي ثابت للمرتبات (إجمالي 18 عمود استيراد/قاعدة بيانات).
